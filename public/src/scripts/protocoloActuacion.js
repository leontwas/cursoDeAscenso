...
{
  question: "Guía de Control Vehicular y Poblacional: Una vez iniciado el operativo se seleccionaran al azar los vehículos que serán sometidos para su control, efectuando las señales correspondientes para su desvío y detención, cuando se detenga el vehículo, el oficial encargado de identificar a los ocupantes deberá:",
  options: [
...
{
  question: "Guía de Detenidos en Centros de Salud: El principio general es que el detenido se encuentre siempre sin los elementos de sujeción colocados, con el fin de evitar que se ocasione lesiones a sí mismo y que pueda causar daños a objetos o lesiones a terceros.",
  options: [
    "VERDADERO",
    "FALSO"
  ],
...
{
  question: "Guía de Detenidos en Centros de Salud: Los oficiales de custodia deben permanecer desarmados y contar con elementos de seguridad y comunicación que les hubieran sido provistos, mantenerse en estado de alerta, en actitud de servicio y presto para actuar ante cualquier situación de peligro o de riesgo de fuga.",
  options: [
    "VERDADERO.",
    "FALSO."
  ],
...
{
  question: "Guía de Traslado y Custodia de Detenidos: Al momento de proceder al traslado de un detenido se debe tener en cuenta:",
  options: [
...
{
  question: "Guía de Traslado y Custodia de Detenidos: Antes de efectuar el traslado de un detenido se debe proceder a realizar la requisa del mismo y de sus pertenencias antes del ingreso al vehículo, debiendo esposarlo con las manos ubicadas por detrás de la espalda a excepción de las mujeres en estado de gravidez, quienes deben ser esposadas con las manos delante del cuerpo.",
  options: [
    "VERDADERO.",
    "FALSO."
  ],
...
{
  question: "Guía de Traslado y Custodia de Detenidos: Cantidad mínima de personal policial que se debe asignar para realizar un traslado en una Unidad de Traslado de Detenidos:",
  options: [
  ...
  correctAnswer: "Se realizara como mínimo con la participación de un chofer, un Oficial Encargado y dos (2) Oficiales como celadores."
},
{
  question: "Guía de Traslado y Custodia de Detenidos: Esta guía posee como objetivo:",
  options: [
...
{
  question: "Guía de Visita para Detenidos: La requisa que se efectúa sobre las personas que van a visitar a un detenido, es una actividad orientada a revisar a una persona y los objetos que posea en el momento de hacerse presente en la Alcaidía, con el fin de identificar elementos que puedan afectar la seguridad, ser de interés para la causa y/o ser constitutivos de un delito.",
  options: [
    "VERDADERO",
    "FALSO."
  ],
...
{
  question: "Guía de Visita para Detenidos: Los medicamentos que tuvieran los visitantes para el detenido:",
  options: [
...
{
  question: "Guía de Visita para Detenidos: Los visitantes menores de dieciocho (18) años:",
  options: [
...
{
  question: "Guía de Detenidos en Centros de Salud: En el caso de un detenido con una enfermedad terminal o que haya sido informado por los médicos del Centro de Salud que se encuentra en estado terminal, se debe:",
  options: [
...
{
  question: "Guía de Traslado y Custodia de Detenidos: Durante el traslado de detenidos, el conductor del vehículo deberá:",
  options: [
...
{
  question: "Guía de Traslado y Custodia de Detenidos: En el caso de que se requiera el uso de medios de fuerza durante el traslado, se deberá:",
  options: [
  ...
  {
    question: "La Dirección Autónoma de Desempeño Profesional, a través de la División Sensibilización y Concientización de Políticas de Género, coordinará con el Instituto Superior de Seguridad Pública, la proyección de planes de instrucción, dirigidos al personal de las distintas áreas, con la finalidad de concientizar la problemática que genera hechos de violencia de género y/o violencia familiar.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "La Dirección Autónoma de Desempeño Profesional, será la responsable de solicitar al Señor Jefe de la Policía de la Ciudad, la iniciación de las actuaciones administrativas tendientes a investigar la conducta del personal que resultara denunciado en la problemática de violencia familiar.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "VERDADERO"
  },
  {
    question: "La División Asistencia Familiar Policial invitará a los presuntos victimarios, a concurrir a la realización del taller Psicoeducativo, que lleva adelante la División Sensibilización y Concientización en Políticas de Género, asimismo indicara a las víctimas, que realicen un taller Psicoeducativo, informando la institución en la cual deberá realizar el mismo.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "La Guía de Paradero de Niños, Niñas y Adolescentes tiene como alcance establecer los lineamientos de actuación relacionados con la toma de denuncia, búsqueda y hallazgo de niños, niñas y adolescentes desaparecidos o extraviados, en el marco del contenido de la Ley Nacional Nº 26.061 y de la Ley Nº 114 de la Ciudad Autónoma de Buenos Aires.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Los resguardos preventivos, cambios o descargos de arma y chalecos balísticos, deben realizarse dentro de las posibilidades de manera personal en la Base operativa de la División Armamento, Munición y Explosivos, contando con:",
    options: ["el informe técnico correspondiente, y la totalidad de elementos constitutivos que le fueron asignados", "la totalidad de elementos oportunamente provistos, Nota e informe técnico", "Ambas respuestas son incorrectas"],
    correctAnswer: "la totalidad de elementos oportunamente provistos, Nota e informe técnico"
  },
  {
    question: "Por razones procesales el personal policial encargado del depósito puede disponer el traslado de los elementos secuestrados y su lugar de resguardo, mientras que el personal del Área de judiciales puede transferir de un depósito a otro dando aviso a la judicatura interviniente.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Posturas que afectan al servicio y menoscaban la imagen institucional: Manos en los bolsillos: es una postura que implica pérdida de la capacidad operativa, dificultando el acceso a los elementos asignados y puede ser percibida como una actitud hostil hacia la comunidad.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Protocolo de Actuación para el ingreso a establecimientos educativos: Finalizada la actuación policial y de haberse labrado acta por parte de las autoridades escolares, no resulta necesario solicitar copia de la misma para ser agregada al informe policial.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Protocolo de Actuación para el ingreso a establecimientos educativos: Al ingresar el personal policial al establecimiento educativo, actuará con estricta sujeción a los protocolos policiales y reglas de procedimiento que sean aplicables a la situación de hecho que motiva la solicitud de intervención.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "VERDADERO"
  },
  {
    question: "Protocolo de Actuación para el ingreso a establecimientos educativos: El presente protocolo fue confeccionado con la finalidad de instruir al personal policial en aquellos casos que deba ingresar a un establecimiento educativo siempre y cuando cuente con la autorización de los miembros directivos del mismo:",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Protocolo de Actuación para el ingreso a establecimientos educativos: Este Protocolo nos brindará los pasos a seguir en aquellos casos en los cuales el personal policial deba ingresar a un establecimiento educativo correspondiente a:",
    options: ["Cualquier nivel o modalidad, de gestión pública de la Ciudad de Buenos Aires.", "Cualquier nivel o modalidad, de gestión pública o privada de la Ciudad de Buenos Aires.", "Cualquier nivel o modalidad, de gestión privada de la Ciudad de Buenos Aires."],
    correctAnswer: "Cualquier nivel o modalidad, de gestión pública o privada de la Ciudad de Buenos Aires."
  },
  {
    question: "Protocolo de Actuación para el ingreso a establecimientos educativos: Toda intervención del personal policial en establecimientos educativos se ajustará a los estándares legales, constitucionales y convencionales establecidos a favor de niñas, niños y adolescentes teniendo en cuenta siempre el interés superior de los mismos.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "VERDADERO"
  },
  {
    question: "Se considera a una persona como desaparecida o extraviada luego de pasadas 24 horas en que se advierte su ausencia, ello con la finalidad de poder coordinar la labor de su búsqueda de manera conjunta con otros organismos y unificar criterios de trabajo.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Si se realiza el hallazgo de un niño, niña o adolescente, en la vía pública y de este no existe denuncia previa de paradero, la Dependencia que lo encontró deberá iniciar actuaciones \"AVERIGUACION DE ILICITO-SOLICITUD DE PARADERO-LEY Nº 114\".",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Solo se podrán realizar maniobras para la limpieza del armamento provisto, con la guía del personal que cumple funciones de armeros en las distintas áreas o dependencias y de surgir alguna novedad relacionada al armamento o munición provistos se informará a la Superioridad.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  },
  {
    question: "Toda la información relacionada con la persona desaparecida se carga en el sistema GAP, de manera completa y correcta para realizar el cotejo con los registros de personas NN de similares características cargadas en el sistema GAP, SIFCOP, SISEP y COP, labrándose:",
    options: ["Una actuación judicial por Averiguación de Ilícito-Búsqueda de Personas y en paralelo un Expediente Constancia con misma carátula.", "Una única actuación judicial por Averiguación de Ilícito-Búsqueda de Personas", "Un único expediente constancia por Averiguación de Ilícito-Búsqueda de Personas"],
    correctAnswer: "Una única actuación judicial por Averiguación de Ilícito-Búsqueda de Personas"
  },
  {
    question: "Un gesto, una posición o una incorrecta portación de los elementos provistos, pueden transmitir a los ciudadanos una imagen institucional que no se corresponde con una buena predisposición al servicio, por lo cual esta guía nos orienta acerca de la importancia de adoptar una correcta postura corporal y uso debido del uniforme durante el servicio.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "VERDADERO"
  },
  {
    question: "Una vez tomado conocimiento de la desaparición de una persona deberemos dar inmediata comunicación a la Fiscalía en lo Penal, Contravencional y de Faltas de la Ciudad de Buenos Aires, a los fines de notificar del hecho y recibir directivas.",
    options: ["VERDADERO", "FALSO"],
    correctAnswer: "FALSO"
  }        
];
